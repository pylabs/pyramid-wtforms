...
class TestPyramidWTFormsValidatorsFileAllowed(unittest.TestCase):
    ...
    def test_call_with_form_and_field_should_raise_error_if_file_ext_is_not_allowed(self):
    ...
    def test_call_with_form_and_field_should_pass_if_files_ext_are_allowed(self):

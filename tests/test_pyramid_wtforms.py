    ...
    def test_pyramid_wtforms_should_have_essential_elements(self):
        ...
        self.assertEqual(
            ['BooleanField', 'DateField', 'DateTimeField', 'DecimalField',
             ...
             'FormField', 'HiddenField', 'IntegerField', 'Label',
             'MultipleFileField', 'MultipleFilesField', 'PasswordField',
             'RadioField', 'SecureForm', 'SelectField', 'SelectFieldBase',
             'SelectMultipleField', 'StringField', 'SubmitField',
             'TextAreaField', 'TextField', 'TimeField', 'ValidationError'],
            essential_elements
        )
